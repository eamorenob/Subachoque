...
var map = new ol.Map({
    ...
    layers: [new ol.layer.Tile({source:new ol.source.OSM()}),lyr_Vias_0,lyr_Centrosacopio_1,lyr_UCS_2,lyr_Clasificacionuso_3,lyr_Limiteoficial_4 ],
    view: new ol.View({
        extent: [-8275840.149043, 539397.339146, -8221141.431338, 568734.484362], maxZoom: 20, minZoom: 4
    })
});
...
map.getView().fit([-8275840.149043, 539397.339146, -8221141.431338, 568734.484362], map.getSize());
map.getView().setCenter(ol.proj.fromLonLat([-74.14418,4.96631]));
